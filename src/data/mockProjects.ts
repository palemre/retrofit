...
export const initialProjects: Record<number, Project> = {
  1: {
    id: 1,
...
export const getInitialProjects = (): Record<number, Project> => {
  return JSON.parse(JSON.stringify(initialProjects)) as Record<number, Project>;
};
